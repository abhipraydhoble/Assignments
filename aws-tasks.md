...
## $${\color{blue}1. Install AWS CLI on Ubuntu Machine}$$
...
## $${\color{blue}2. Host CSS Template for Nginx and HTTPD Simultaneously on Same Linux Server}$$
...
## $${\color{blue}3. Create Image from Instance and Launch Another Instance}$$
   - Create an AMI (Amazon Machine Image) from an existing EC2 instance.
   - Launch a new EC2 instance using the created AMI.

## $${\color{blue}4. CloudWatch with Auto Scaling Group (ASG)}$$
...
### $${\color{green}Additional AWS Networking Tasks:}$$

## $${\color{purple}1. Subnetting and Network Calculation (CIDR Range: 172.21.0.0/16)}$$
